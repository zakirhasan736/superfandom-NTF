...
const TokenCards: React.FC<ITokenCards> = ({
  _id,
  image = '/images/card-img-11.png',
  cardInfo,
  bidNowBg,
  userPhoto = '/images/user-img.png',
  bidNow,
  cardInfoBg,
  price,
  description,
  ...
  return (
    <div
      className="token-card--items  w-[382px] md:w-full md:min-w-[216px] lg:w-[290px] laptop-x:w-[300px] laptop-m:w-[350px] desktop-m:w-[350px] rounded-3xl overflow-hidden bg-primary md:rounded-2xl"
      key={_id}
    >
        ...
        <div className="tokens-img-wrap relative">
          ...
          <div className="tokens-card-top-cont flex justify-between items-start absolute top-0 left-0 p-5 w-full md:p-2">
            <a
              href="/"
              className={[
                'link-item-text uppercase text-fig-15 bg-secondary text-primary text-center lg:text-fig-12 md:text-fig-xs font-primary font-normal p-[10px] rounded-[40px]',
                `bg-${bidNowBg}`,
              ].join(' ')}
            >
              {bidNow}
            ...
            <span
              className={[
                'card-updates-info  text-fig-15 uppercase text-secondary block  text-center lg:text-fig-12 md:text-fig-xs font-primary font-normal rounded-[100%] w-[62px] h-[62px] leading-[62px]',
                `bg-${cardInfoBg}`,
              ].join(' ')}
            >
              {cardInfo}
      ...
      <div className="token-card-content-box pt-[13px] pb-4 px-6 md:p-2">
        ...
        <p className="desc mb-4 text-fig-xs text-left text-secondary font-primary font-normal md:text-[8px] md:mb-2">
          {description}
        </p>
