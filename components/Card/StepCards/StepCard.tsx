...
const StepCard: React.FC<IStepCard> = ({id,photo_name, title, desc}) => {
  return (
    <div className="steps-card--items md:mb-5 pt-[29px] pr-9 pb-8 pl-4 sm:py-4 sm:pr-4 relative border-solid border-2 border-secondary h-[400px] laptop-m:h-[340px] lg:h-[325px] rounded-3xl bg-primary md:h-auto md:" key={id}>
...
/>
    ...
    <div className="steps-card-content-box pl-40 desktop-m:pl-32 laptop-x:pl-16 mt-[52px] lg:pl-0 lg:mt-10 md:pl-[80px] sm:pl-[75px] md:mt-0">
