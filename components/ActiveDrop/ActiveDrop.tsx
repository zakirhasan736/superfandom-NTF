    ...
    <>
      <section className="active-drop-section w-full bg-primary pt-[142px] laptop-m:pt-[65px]  md:pt-8 pb-16 md:pb-11 px-0 relative z-10  overflow-hidden">
        ...
        <div className="container 2xl:container xl:container lg:container md:container sm:container 2xl:px-12 laptop-x:px-0 xl:px-12  lg:px-0 0 md:px-0 sm:px-0">
          <div className="active-drop-content-wrapper px-28 py-[100px] laptop-x:py-16 desktop-l:px-12 md:px-5 md:py-0 sm:pb-8 w-full h-full bg-primary rounded-3xl overflow-hidden laptop-x:rounded-none">
              ...
              <ul className="active-drop-slides-cards flex no-wrap gap-5">
                ...
                {ActiveCards.map(
                  ({
                    ...
                    <li className="active-drop-cards-items w-[518px] h-[432px] md:min-w-[300px] md:w-[300px] md:h-[100%]" key={id}>
                      <ActiveCard
                        id={id}
