      ...
      <nav className='navbar'>
                <div className="nav-contantwrapper flex items-center justify-between md:block">
                    ...
                    <ul className="nav-items flex items-center mr-[76px] lg:mr-[25px] md:mr-0 md:block md:mb-16">
                        <li className='uppercase font-primary font-normal text-secondary p-5 mr-5 md:mr-0 text-fig-15 lg:mr-[7px] md:text-fig-32 md:w-full md:p-8 md:border-t md:border-solid md:border-secondary md:text-center '><Link href="/"><a>CAUSES</a></Link></li>
                        <li className='uppercase font-primary font-normal text-secondary p-5 mr-5 md:mr-0 text-fig-15 lg:mr-[7px] md:text-fig-32 md:w-full md:p-8 md:border-t md:border-solid md:border-secondary md:text-center '><Link href="/"><a>FANDOMS</a></Link></li>
                        <li className='uppercase font-primary font-normal text-secondary p-5 mr-5 md:mr-0 text-fig-15 lg:mr-[7px] md:text-fig-32 md:w-full md:p-8 md:border-t md:border-solid md:border-secondary md:text-center '><Link href="/"><a>CAMPAIGN</a></Link></li>
                        <li className='uppercase font-primary font-normal text-secondary p-5 mr-0 md:mr-0 text-fig-15 lg:mr-[7px] md:text-fig-32 md:w-full md:p-8 md:border-t md:border-b md:border-solid md:border-secondary md:text-center '><Link href="/"><a>SERVICES</a></Link></li>
                    </ul>
