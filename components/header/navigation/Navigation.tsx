...
const Header: React.FC<INavigation> = ({
  ...
  return (
    <header
      {...headerProps}
      className={`${
        headerNext ? 'bg-white white-varient-navbar' : 'bg-primary'
      ...
      <div className="container lg:container md:container sm:container 2xl:px-12 xl:px-12 lg:px-8  sm:px-4 md:px-0">
        <nav className="navbar">
          <div className="nav-contantwrapper flex items-center justify-between md:block">
            ...
            <div
              className={`navbar-cont-box flex items-center  md:block md:absolute md:left-0 md:top-0 md:pt-[166px] sm:pt-[120px] md:pb-[103px] md:z-[9999] md:bg-primary md:w-full ${
                open && 'navbar-box-active'
              }`}
            >
