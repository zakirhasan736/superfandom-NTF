                ...
                <div className="product-cont-box desc-box bg-lightgray px-10 py-10 mb-0 rounded-[20px] w-full">
                  <div className="offer-list-box">
                    ...
                    <table className="offer-table w-full">
                        <thead>
                        <tr>
                          <th className='border-b uppercase  border-secondary font-primary font-normal text-darkgray text-fig-15 text-left py-2'>minted</th>
                          <th className='border-b uppercase  border-secondary font-primary font-normal text-darkgray text-fig-15 text-left py-2'>Editions</th>
                        </tr>
                        </thead>
                    <tbody>
                       <tr>
                          <td className='font-primary font-normal text-primary text-fig-15 text-left py-2'>82,377 STX</td>
                          <td className='font-primary font-normal text-primary text-fig-15 text-left py-2'>2 hours</td>
                        </tr>
                    </tbody>
