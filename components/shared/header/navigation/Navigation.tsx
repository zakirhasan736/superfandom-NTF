          ...
          <div className="nav-contantwrapper flex items-center justify-between md:block">
            ...
            >
              <ul className="nav-items flex items-center mr-[76px] lg:mr-[25px] md:mr-0  md:mb-16 md:hidden">
                <NavLink name={"explore"} href={'/'} title="" pageName=""/>
              </ul>
              <ul className="nav-items items-center mr-[76px] lg:mr-[25px] md:mr-0 md:mb-16 hidden md:block">
                <NavLink name={"CAUSES"} title={"causespage"} href={'/causespage'} pageName={pageName} />
                <NavLink name={"FANDOMS"} title={"fandom"} href={'/fandom'} pageName={pageName} />
                <NavLink name={"CAMPAIGN"} title={"campaign"} href={'/campaign'} pageName={pageName} />
                <NavLink name={"SERVICES"} title={"/"} href={'/'} pageName={pageName} />
              </ul>
