...
const HowItWork: NextPage<any> = ({}) => {
  useEffect(() => {
    ...
    gsap.utils
      .toArray('.scrolable-text-box.how-it-work-title')
            ...
            <div className="scrolable-text-box how-it-work-title">
              <div className="scroll-text-item">
                <h2 className="section-title scrollable--title font-primary font-normal text-fig-5x text-center uppercase md:text-fig-xx sm:text-fig-32">
                  • how it work • how it work • how it work • how it work • how
                  it work • how it work • how it work • how it work • how it
                  work • how it work
                </h2>
              </div>
            </div>
                  ...
                  <div className="how-it-work-anim-cont w-full relative sm:mb-8 md:text-right md:flex md:justify-center">
                    <div className="text-count-item-box w-full relative md:flex md:justify-end md:max-w-[270px] md:w-full">
                      ...
                      <div className="how-it-work-anim-btn-box absolute bottom-0 left-0">
                        <Link href="/">
                          <a className="anim-item-btn font-primary relative bottom-[161px] font-normal text-fig-15 text-center text-primary border border-solid border-primary bg-neon hover:bg-secondary uppercase p-5 w-[245px] block rounded-[40px] z-50">
                            mint now
                          </a>
                        </Link>
                  ...
                  <div className="how-it-work-anim-cont w-full relative flex justify-end md:justify-center sm:mb-8">
                    <div className="text-count-items-box md:max-w-[320px] md:w-full relative">
                      ...
                      <div className="how-it-work-anim-btn-box absolute bottom-0 right-0">
                        <Link href="/">
                          <a className="anim-item-btn font-primary relative bottom-[131px] font-normal text-fig-15 text-center text-primary border border-solid border-primary bg-secondary hover:bg-neon uppercase p-5 w-[245px] block z-50 rounded-[40px]">
                            your collection
                          </a>
                        </Link>
                ...
                <li className="how-it-work-info-list info-list3 flex items-center flex-row gap-[190px] lg:gap-[120px] md:flex-col-reverse md:mb-8">
                  ...
                  <div className="how-it-work-anim-cont w-full relative flex justify-center mb-8">
                    <div className="text-cont-item-box md:max-w-[270px] md:w-full relative">
                      ...
                      <div className="how-it-work-anim-btn-box absolute bottom-0 left-0">
                        <Link href="/">
                          <a className="anim-item-btn font-primary relative bottom-[161px] font-normal flex items-center justify-between text-fig-24 text-center text-primary border border-solid border-primary bg-secondary uppercase py-5 px-[45px] w-[245px]  rounded-[40px]">
